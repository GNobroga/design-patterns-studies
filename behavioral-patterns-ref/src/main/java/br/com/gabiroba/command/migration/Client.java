package br.com.gabiroba.command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import br.com.gabiroba.command.migration.commands.ProductTable;
import br.com.gabiroba.command.migration.commands.UserTable;
import br.com.gabiroba.command.migration.commands.UserTableRoleColumn;
