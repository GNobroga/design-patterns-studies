package br.com.gabiroba.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.gabiroba.command.alexa.before.lights.PhillipsHueLight;
import br.com.gabiroba.command.alexa.before.lights.XiaomiLight;
