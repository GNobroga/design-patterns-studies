package br.com.gabiroba.command.alexa.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.gabiroba.command.alexa.lights.PhillipsHueLight;
import br.com.gabiroba.command.alexa.lights.XiaomiLight;
